...
$(document).ready(function(){
    ...
    // Stop carousel when user focuses on form
    $('.form-input').on('focus', function(){
        owl.trigger('stop.owl.autoplay');
    });

    // Resume carousel when user leaves form
...
function setTopbarHeightVariable() {
...
setTopbarHeightVariable();
window.addEventListener('resize', setTopbarHeightVariable);
